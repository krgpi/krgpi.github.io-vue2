    ...
    <div class="body_container">
        ...
        <div class="category-box">
          <h3>
            <a
              ...
              target="_blank"
            >TopicNote <mark class="tag">webサイト</mark></a>
          </h3>
          <p>自らが立ち上げたプロジェクトチームで、他の学類も含め最大5名の筑波大生を集め、共通認識の構築や技術的なアシストを行いつつ、ウェブサービスの作成を行った。</p>
        </div>
      </div>
      <h1>2018</h1>
      <div class="container">
        <div class="category-box">
          <h3>reunion vol.1 2018.11 <mark class="tag">フォトブック</mark></h3>
          <img src="/img/reunion_small.png" width="200px">
          <p>
            平成30年11月3日,4日に筑波大学雙峰祭(芸術祭)の写真部写真展 場所：筑波大学5C棟513室にて、オリジナル写真集"reunion - 再会"を販売しました。
            •価格等の概要
            A4 20ページ フルカラー
            全ページ半光沢の写真用紙を使用 A4見開き全面印刷の写真を2枚含む全25枚
            無料アプリ AsahiARによる追加画像及び映像コンテンツが閲覧可能（試験的）
            50部限定印刷
            •内容
      ...
      <div class="container">
        <div class="category-box">
          <h3>
            <a
              href="http://ar-ap-inc.jp"
              target="_blank"
            >Asahi AR <mark class="tag">アプリ・バックエンド</mark></a>
          </h3>
          ...
          <div class="item">
            <p>
              ...
              <b>サービス概要</b>
              AsahiARとは、紙媒体を始めとする現実世界のオブジェクトと、デジタルメディアを融合させる、"Augmented Reality (AR)"を使ったアプリケーションです。
      ...
      <div class="container">
        <div class="category-box">
          <h3>ねこのせかい <mark class="tag">フォトブック</mark></h3>
          <img src="/img/nekono_sekai.jpg" width="200px">
          <p>
